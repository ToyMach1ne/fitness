    ...
    function() {
        ...
        plp.cart.add = function(e) {
            ...
            l.append(c), c.find('[data-role="setamount"]').val(o.value), c.find('[data-role="itemprice"]').html(r.value), c.find('[data-role="itemname"]').html(t.value), c.find('[data-role="itemphoto"]').css("backgroundImage", 'url("' + (i.value || n) + '")'), u = u.add(c), c.on("setamount", function(e, t) {
                ...
                plp.cart.list = _.without(plp.cart.list, e), store.set("cart", plp.cart.list), c.slideUp(250, function() {
...
function(e, t, n, r) {
            ...
            $(function() {
                try {
                    ...
                    return $.fn.findUpmost = function(e) {
                        ...
                        close: function() {
                            try {
                                ...
                                return e = _.last(t).modal("hide"), e.find(".macros-video").each(function() {
                                    try {
                                        var e;
                                        return e = $(this).find(".wrap"), e.attr("src", e.attr("src"))
                                    } catch (t) {
                        ...
                        try {
                            var e, t, n, r;
                            return e = $(this), n = e.closest(".node"), r = e.attr("data-modal"), n.length || (n = e.closest(".modal")), "cart" === r && (n = $("div.area").first()), t = n.findUpmost('.modal[data-modal="' + r + '"]'), plp.modal.init(e, t)
                        } catch (o) {
    ...
    function() {
        try {
            $(function() {
                try {
                    var e, t, n, r, o, i, a, l, s, u, c;
                    return i = window.plp_page_id || window.plp.page_id, e = window.plp_content_id || window.plp.content_id, c = $.cookie("visit_id"), l = 0, a = 2500, n = {
                        ru: {
                    ...
                    }, t = n[window.plp_lang || window.plp.lang || "ru"], u = "Да", s = "Нет", r = function(e, t, n) {
                        try {
                            var r;
                        ...
                        try {
                            var n, d, f, p, h, m, y, v;
                            return f = $(this), h = f.data("form"), m = f.closest("[data-item]").data("item") || [], y = f.closest('[data-modal="cart"]').length ? plp.cart.list : [], p = f.data("fields"), v = {
                                hit: {
                                    page_id: i,
                                    ab_id: e,
                                    visit_id: c
                                ...
                                try {
                                    var t, n;
                                    if (t = $(this), n = v.fields[e], "radio-list" === n.type && t.find("input").prop("name", _.uniqueId("radio")), "textarea" === n.type) return t.find("textarea").val(function(e, t) {
                                        try {
                                            return $.trim(t)
                                        } catch (n) {
                                    ...
                                    error_handler(r, "red libs 9", arguments.callee)
                                }
                                ...
                                try {
                                    ...
                                    return e.data("placeholder", !0), t = e.val(), e.on("focus", function(t) {
                                        try {
                                            ...
                                            error_handler(n, "red libs 12", arguments.callee)
                                        }
                                    }), e.on("blur", function(n) {
                                        try {
                                            if ("" === e.val()) return e.val(t).data("placeholder", !0)
                                        } catch (r) {
                                            error_handler(r, "red libs 13", arguments.callee)
                                        }
                                    })
                                } catch (n) {
                                    error_handler(n, "red libs 11", arguments.callee)
                                }
                            }), n = f.find(".submit"), f.on("submit", function(e) {
                                try {
                                    var i, c, p, m;
                                    return e.preventDefault(), $.now() - a < l ? void r(t.error, t.interval) : (c = [], d.each(function(e) {
                                        try {
                                            var n;
                                            if ("checkbox-input" === v.fields[e].type ? v.fields[e].value = $(this).find("input").prop("checked") ? u : s : "radio-list" === v.fields[e].type ? v.fields[e].value = $(this).find("[type=radio]:checked").val() || "" : "select-menu" === v.fields[e].type ? v.fields[e].value = $(this).find("select").val() : "hidden" === v.fields[e].type ? (v.fields[e].name = v.fields[e].id, v.fields[e].value = $(this).find("input").val()) : (n = $(this).find(".form-control").data("placeholder"), v.fields[e].value = n ? "" : $(this).find(".form-control").val()), v.fields[e].required && "" === v.fields[e].value && c.push(t.required.replace("%field%", v.fields[e].name)), "" === v.fields[e].value) return;
                                            if ("email" !== v.fields[e].type || /.+@.+\..+/.test(v.fields[e].value) || c.push(t.email.replace("%field%", v.fields[e].name)), "phone" === v.fields[e].type && !/.*\d.*\d.*\d.*\d.*/.test(v.fields[e].value)) return c.push(t.phone.replace("%field%", v.fields[e].name))
                                        } catch (r) {
                                            error_handler(r, "red libs 15", arguments.callee)
                                        }
                                    }), c.length > 0 ? void r(t.validate, c.join("\n")) : (m = {
                                        name: "",
                                        phone: "",
                                        email: "",
                                        count: "",
                                        ...
                                        try {
                                            var t;
                                            if ("" === m[e.type] && (m[t = e.type] || (m[t] = e.value)), !m.fields[e.name]) return m.fields[e.name] = e.value
                                        } catch (n) {
                                            error_handler(n, "red libs 16", arguments.callee)
                                        }
                                    }), _.each(v.item, function(e) {
                                        try {
                                            var t, n;
                                            return (t = m.item)[n = e.type] || (t[n] = _.escape(e.value))
                                        } catch (r) {
                                            error_handler(r, "red libs 17", arguments.callee)
                                        }
                                    }), n.prop("disabled", !0), p = function(e, i, a) {
                                        try {
                                            var s, u, c, d;
                                            return _.defaults(e, m), console.log("Данные формы", {
                                                time: e.time,
                                                name: e.name,
                                                email: e.email,
                                                phone: e.phone,
                                                ...
                                                fields: e.fields,
                                                item: e.item
                                            }), n.prop("disabled", !1), 0 === e.result ? r(t.error, e.errors) : 1 === e.result ? (d = n.data("ym_goal"), window.yaCounter && yaCounter.reachGoal(d), u = n.data("ga_category"), s = n.data("ga_action"), window.ga && ga("send", "event", u, s), "msg" === h.after ? o(_.template(h.msg, e), null) : "url" === h.after ? location.href = _.template(h.url, e) : "addhtml" === h.after ? $("body").append(_.template(h.addhtml, e)) : "msg+url" === h.after ? o(_.template(h.msg, e), null, function() {
                                                try {
                                                    return location.href = _.template(h.url, e)
                                                } catch (t) {
                                                    error_handler(t, "red libs 19", arguments.callee)
                                                }
                                            }) : "msg+addhtml" === h.after ? o(_.template(h.msg, e), null, function() {
                                                try {
                                                    return $("body").append(_.template(h.addhtml, e))
                                                } catch (t) {
                                                    error_handler(t, "red libs 20", arguments.callee)
                                                }
                                            }) : "js" === h.after && (c = "(function () { var time = <%= time %>; var name = '<%- name %>'; var email = '<%- email %>'; var phone = '<%- phone %>'; var count = '<%- count %>'; var fields = <%= JSON.stringify(fields) %>; var item = <%= JSON.stringify(item) %>; var send = <%= JSON.stringify(send) %>;" + h.js + "})();", $.globalEval(_.template(c, e)))) : r(t.error, null), f.trigger("reset").find("[data-placeholder]").data("placeholder", !0), y.length && plp.cart.empty(), plp.modal.closeAll(), l = $.now()
                                        } catch (p) {
                                            error_handler(p, "red libs 18", arguments.callee)
                                        }
                                    }, i = function(e, o, i) {
                                        try {
                                            return n.prop("disabled", !1), r(t.error, 400 === e.status ? e.responseText : null), l = $.now()
                                        } catch (a) {
                                            error_handler(a, "red libs 21", arguments.callee)
                                        }
                                    }, $.ajax("/app/c", {
                                        type: "POST",
                                    ...
                                    error_handler(g, "red libs 14", arguments.callee)
                                }
                            })
                        } catch (g) {
                            error_handler(g, "red libs 8", arguments.callee)
                        }
                    })
                } catch (d) {
                    error_handler(d, "red libs 1", arguments.callee)
                }
            })
        } catch (e) {
            error_handler(e, "red libs 0", arguments.callee)
                    ...
                    for (n = function() {
                        ...
                        try {
                            ...
                            if (i = document.createElement("span"), i.innerHTML = "giItT1WQy@!-/#", i.style.position = "fixed", i.style.left = "-10000px", i.style.top = "-10000px", i.style.fontSize = "1000px", i.style.fontFamily = "sans-serif", i.style.fontVariant = "normal", i.style.fontStyle = "normal", i.style.fontWeight = "normal", i.style.letterSpacing = "0", document.body.appendChild(i), l = i.offsetWidth, i.style.fontFamily = t, o = void 0, r = function() {
                                    try {
                                        if (i && i.offsetWidth !== l && (++a,
                                                i.parentNode.removeChild(i), i = null), a >= e.length && (o && clearInterval(o), a === e.length)) return n(), !0
                                    } catch (t) {
                                        error_handler(t, "red libs 6", arguments.callee)
                                    }
            ...
            $(function() {
                try {
                    return $(".section-slider").each(function() {
                        try {
                            var e, t;
                            return e = $(this).find("> .wrapper1 > .wrapper2 > .container > .incon > .wrap"), t = e.find(">"), t.data("$slider", t), plp.lazy.add(t, function() {
                                try {
            ...
            $(function() {
                try {
                    return $(".widget-slider").each(function() {
                        try {
                            var e, t;
                            return e = $(this).find("> .wrapper1 > .wrapper2 > .wrap"), t = e.find(""), t.data("$slider", t), plp.lazy.add(t, function() {
                                try {
                                    return plp.lazy.force(t)
                                } catch (e) {
                                    error_handler(e, "red libs 3", arguments.callee)
